...
///
/// assert_eq!(get_html_char_ref("amp" ).unwrap(), "&");
/// assert_eq!(get_html_char_ref("#65" ).unwrap(), "A");
/// assert_eq!(get_html_char_ref("#x41").unwrap(), "A");
///
/// get_html_char_ref("unknown").unwrap_err();
///
/// assert_eq!(get_html_char_ref("#65" ).unwrap(), "A");
/// assert_eq!(get_html_char_ref("#x41").unwrap(), "A");
///
