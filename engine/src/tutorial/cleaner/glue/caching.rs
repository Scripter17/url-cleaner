...
//!
//! URL Cleaner Engine has a defence against cache detection and a defence against thread count detection that happens to also be theoretically useful for defending against cache detection.
//!
...
//!
//! Both URL Cleaner's CLI and URL Cleaner Site disable these defences by default, with URL Cleaner Site Userscript enabling them only for its jobs.
//!
