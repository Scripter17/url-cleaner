...
/// The enum of errors [`FlagRef::get`] can return.
#[derive(Debug, Error)]
pub enum GetFlagError {
    ...
    StringSourceIsNone,
    /// Returned when trying to use [`FlagRef::CommonArg`] outside of a common context.
    #[error("Tried to use FlagRef::CommonArg outside of a common context.")]
    NotInCommonContext
}
