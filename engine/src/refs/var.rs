...
/// The enum of errors [`VarRef::get`] can return.
#[derive(Debug, Error)]
pub enum GetVarError {
    ...
    StringSourceIsNone,
    /// Returned when trying to use [`VarRef::CommonArg`] outside of a common context.
    #[error("Tried to use VarRef::CommonArg outside of a common context.")]
    NotInCommonContext,
