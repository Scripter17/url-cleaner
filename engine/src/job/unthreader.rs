...
/// Allows multiple tasks sharing an [`Unthreader`] to force each other to not do certain long operations in parallel.
///
/// This allows hiding the thread count of a frontend from actors who can give arbitrary inputs and measure the timing of the outputs.
///
