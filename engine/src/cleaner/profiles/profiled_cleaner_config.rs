...
/// Used to make either a [`ProfiledCleaner`] or just a [`Cleaner`] for a specific profile.
///
/// Generally should not be deserialized from a file, since the independence of the [`Cleaner`] file and [`ProfilesConfig`] file is a major ergonomic benefit, but the option is there.
