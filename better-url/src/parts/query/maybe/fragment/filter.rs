...
impl MaybeFragmentQuery<'_> {
    ...
    pub fn filtered<F: FnMut(&FragmentQuerySegment<'_>) -> bool>(mut self, f: F) -> (bool, Self) {
        (self.filter(f), self)
    }
    ...
    pub fn try_filtered<F: FnMut(&FragmentQuerySegment<'_>) -> Result<bool, E>, E>(mut self, f: F) -> Result<(bool, Self), E> {
    ...
    pub fn try_filter<F: FnMut(&FragmentQuerySegment<'_>) -> Result<bool, E>, E>(&mut self, mut f: F) -> Result<bool, E> {
