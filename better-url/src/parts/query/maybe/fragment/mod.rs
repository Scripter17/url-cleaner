...
impl<'a> From<Option<Cow<'a, [u8]>>> for MaybeFragmentQuery<'a> {
...
impl<'a> From<Option<QueryLikeSegment      <'a>>> for MaybeFragmentQuery<'a> {fn from(value: Option<QueryLikeSegment      <'a>>) -> Self {Self(value.map(Into::into))}}
