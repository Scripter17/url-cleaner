...
impl MaybeSpecialQuery<'_> {
    /// [`SpecialQuery::set`].
    ///
    /// If [`Self::0`] is [`None`], `index` is 0 or 1, and `value` is [`Some`], creates a new [`SpecialQuery`] with [`SpecialQuerySegment::from_pair`].
    ///
    /// If the call to [`SpecialQuery::set`] returns the error [`CantBeNone`], sets [`Self::0`] to [`None`].
    /// # Errors
