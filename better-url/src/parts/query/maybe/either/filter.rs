...
impl MaybeQuery<'_> {
    ...
    /// # Errors
    /// If [`MaybeSpecialQuery::try_filtered`] returns an error, that error is returned.
    ///
    /// If [`MaybeNonSpecialQuery::try_filtered`] returns an error, that error is returned.
    ...
    /// # Errors
    /// If [`MaybeSpecialQuery::try_filter`] returns an error, that error is returned.
    ///
    /// If [`MaybeNonSpecialQuery::try_filter`] returns an error, that error is returned.
