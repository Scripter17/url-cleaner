...
impl<'a> MaybeQueryLike<'a> {
    ...
    /// # Errors
    /// If [`MaybeQuery::try_filtered`] returns an error, that error is returned.
    ///
    ...
    /// # Errors
    /// If [`MaybeQuery::try_filter`] returns an error, that error is returned.
    ///
    /// If [`MaybeFragmentQuery::try_filter`] returns an error, that error is returned.
