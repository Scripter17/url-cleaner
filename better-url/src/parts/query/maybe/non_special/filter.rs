...
impl MaybeNonSpecialQuery<'_> {
    ...
    pub fn filter<F: FnMut(&NonSpecialQuerySegment<'_>) -> bool>(&mut self, mut f: F) -> bool {
    ...
    pub fn try_filter<F: FnMut(&NonSpecialQuerySegment<'_>) -> Result<bool, E>, E>(&mut self, mut f: F) -> Result<bool, E> {
