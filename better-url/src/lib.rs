...
//!    I promise the fact this handicap benefits me is incidental.
//!
//! 3. The speed factor varies wildly depending on the URL.
//!    It can get as low as 0.5x or as high as 2x.
